...
twelve = ['STEEMUSDT', 'NEXOUSDT', 'REIUSDT', 'LDOUSDT', 'OPUSDT', 'RENDERUSDT', 'STGUSDT', 'LUNCUSDT', 'GMXUSDT', 'POLYXUSDT', 'APTUSDT', 'BANANAUSDT']
    ...
    for name_cript_check in trading_pairs:
        try:
            ...
            if time.localtime(time.time()).tm_min == 59 and time.localtime(time.time()).tm_hour in time_frames:
                ...
                if -4.7 > res > -20 and percent_raznici_svechei > 15 and res_sum5 > 15 and b > -30:
                    ...
                    if name_cript_check not in [i['name_cript'] for i in get_crypto("`vision_equals`")] and volume_per_5h > 7500 and res_k_low > 200:
                        equal("`vision_equals`", name_cript_check, res, res_before, price_change_percent_24h, awerage_high_frame,
                              sell_pr, res_sum5)
        except:
            pass
